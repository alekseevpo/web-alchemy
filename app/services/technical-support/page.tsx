...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: t('services.support.title') + ' - Web-Alchemy',
    description: t('services.support.desc'),
    alternates: {
      canonical: `${siteUrl}/services/technical-support`,
    },
    openGraph: {
      title: t('services.support.title') + ' - Web-Alchemy',
      description: t('services.support.desc'),
      url: `${siteUrl}/services/technical-support`,
    },
  };
}

export default function Page() {
  return <ServiceDetailPage serviceKey="support" />;
}
